...
public final class RecipeHelper {
    ...
    public static void addChemicalInfuserRecipe(GasStack leftInput, GasStack rightInput, GasStack output) {
        try {
            Class recipeClass = Class.forName("mekanism.common.recipe.RecipeHandler");
            Method m = recipeClass
                .getMethod("addChemicalInfuserRecipe", GasStack.class, GasStack.class, GasStack.class);
    ...
    public static void addPrecisionSawmillRecipe(ItemStack input, ItemStack primaryOutput, ItemStack secondaryOutput,
        ...
        try {
            Class recipeClass = Class.forName("mekanism.common.recipe.RecipeHandler");
            Method m = recipeClass
                .getMethod("addPrecisionSawmillRecipe", ItemStack.class, ItemStack.class, ItemStack.class, Double.TYPE);
    ...
    public static void addChemicalInjectionChamberRecipe(ItemStack input, String gasName, ItemStack output) {
        try {
            Class recipeClass = Class.forName("mekanism.common.recipe.RecipeHandler");
            Method m = recipeClass
                .getMethod("addChemicalInjectionChamberRecipe", ItemStack.class, String.class, ItemStack.class);
     ...
     */
    public static void addElectrolyticSeparatorRecipe(FluidStack input, double energy, GasStack leftOutput,
