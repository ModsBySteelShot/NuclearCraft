...
public class OxidiserRecipes extends NCRecipeHelper {
    ...
    public void fuelFuel(int oxyNum, int metaIn, int metaOut) {
        addRecipe(
            new ItemStack(NCItems.fuel, 1, metaIn),
            new ItemStack(NCItems.fuel, oxyNum, 35),
            new ItemStack(NCItems.fuel, 1, metaOut),
            new ItemStack(NCItems.fuel, oxyNum, 45));
    }

    public void matMat(int oxyNum, int metaIn, int metaOut) {
        addRecipe(
            new ItemStack(NCItems.material, 1, metaIn),
            new ItemStack(NCItems.fuel, oxyNum, 35),
            new ItemStack(NCItems.material, 1, metaOut),
            new ItemStack(NCItems.fuel, oxyNum, 45));
    }
