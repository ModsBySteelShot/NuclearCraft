...
public class FusionRecipes extends NCRecipeHelper {
    ...
    public void recipe(int in1, int in2, int out1, int out2, int out3, int out4, int out5, int out6) {
        addRecipe(
            new ItemStack(NCItems.fuel, 16, in1),
            new ItemStack(NCItems.fuel, 16, in2),
            out1 != 0 ? new ItemStack(NCItems.fuel, out1, 47) : new ItemStack(NCItems.blank, 1),
            out2 != 0 ? new ItemStack(NCItems.fuel, out2, 36) : new ItemStack(NCItems.blank, 1),
            out3 != 0 ? new ItemStack(NCItems.fuel, out3, 37) : new ItemStack(NCItems.blank, 1),
            out4 != 0 ? new ItemStack(NCItems.fuel, out4, 38) : new ItemStack(NCItems.blank, 1),
            out5 != 0 ? new ItemStack(NCItems.fuel, out5, 39) : new ItemStack(NCItems.blank, 1),
            out6 != 0 ? new ItemStack(NCItems.fuel, out6, 40) : new ItemStack(NCItems.blank, 1));
    }
}
