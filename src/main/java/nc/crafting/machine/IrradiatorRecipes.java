...
public class IrradiatorRecipes extends NCRecipeHelper {
    ...
    public void recipeNeutron(Item In, int noIn, int metaIn, Item Out, int noOut, int metaOut, Item Out2, int noOut2,
        int metaOut2) {
        addRecipe(
            new ItemStack(In, noIn, metaIn),
            new ItemStack(NCItems.fuel, 1, 47),
            new ItemStack(Out, noOut, metaOut),
            new ItemStack(Out2, noOut2, metaOut2),
            new ItemStack(NCItems.fuel, 1, 48));
    }

    public void recipeNeutron2(Item In, int noIn, int metaIn, Item Out, int noOut, int metaOut, Item Out2, int noOut2,
        int metaOut2) {
        addRecipe(
            new ItemStack(In, noIn, metaIn),
            new ItemStack(NCItems.fuel, 1, 47),
