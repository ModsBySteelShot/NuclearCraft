...
public class IoniserRecipes extends NCRecipeHelper {
    ...
    public void fuelFuel(int noIn, int metaIn, int noIn2, int metaIn2, int noOut, int metaOut, int noOut2,
        int metaOut2) {
        addRecipe(
            new ItemStack(NCItems.fuel, noIn, metaIn),
            new ItemStack(NCItems.fuel, noIn2, metaIn2),
            new ItemStack(NCItems.fuel, noOut, metaOut),
            new ItemStack(NCItems.fuel, noOut2, metaOut2));
    }
}
