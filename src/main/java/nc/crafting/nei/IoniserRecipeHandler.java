...
public class IoniserRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(54, 23, 69, 41), "ionising", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("ionising")) && (getClass() == IoniserRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = IoniserRecipes.instance()
                .getRecipes();
    ...
    public void loadCraftingRecipes(ItemStack result) {
        Map<Object[], Object[]> recipes = IoniserRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            int pos = IoniserRecipes.instance()
