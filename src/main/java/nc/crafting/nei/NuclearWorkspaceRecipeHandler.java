...
public class NuclearWorkspaceRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(97, 29, 29, 41), "nwcrafting", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("nwcrafting") && getClass() == NuclearWorkspaceRecipeHandler.class) {
            for (IRecipe irecipe : (List<IRecipe>) NuclearWorkspaceCraftingManager.getInstance()
                .getRecipeList()) {
