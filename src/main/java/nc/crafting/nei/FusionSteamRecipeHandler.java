...
public class FusionSteamRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public SmeltingPair(Object input, Object input2, Object result, Object result2, Object result3, Object result4,
            Object result5, Object result6) {
            super();
            // input.stackSize = 1;
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(40, 141, 124, 18), "fusing", new Object[0]));
        // this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(166, 219, 66, 18),
        // "fusing", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("fusing")) && (getClass() == FusionSteamRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = FusionRecipes.instance()
                .getRecipes();
    ...
    public void loadCraftingRecipes(ItemStack result) {
        Map<Object[], Object[]> recipes = FusionRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            int pos = FusionRecipes.instance()
