...
public class OxidiserRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(54, 23, 69, 41), "oxidising", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("oxidising")) && (getClass() == OxidiserRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = OxidiserRecipes.instance()
                .getRecipes();
    ...
    public void loadCraftingRecipes(ItemStack result) {
        Map<Object[], Object[]> recipes = OxidiserRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            int pos = OxidiserRecipes.instance()
