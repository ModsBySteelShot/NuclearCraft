...
public class CrusherRecipeHandler extends TemplateRecipeHandler {
    ...
    public TemplateRecipeHandler newInstance() {
        if (ecrushfuels == null) findCrushFuels();
    ...
    private static void findCrushFuels() {
        ...
        for (ItemStack item : ItemList.items) if (!ecrushfuels.contains(item.getItem())) {
    ...
    public static int getItemBurnTime(ItemStack itemstack) {
        if (itemstack == null) {
            ...
            if (item instanceof ItemTool && ((ItemTool) item).getToolMaterialName()
                .equals("WOOD")) return 8000 / NuclearCraft.crusherCrushEfficiency;
            ...
            if (item == Item.getItemFromBlock(Blocks.sapling)) return 4000 / NuclearCraft.crusherCrushEfficiency;
