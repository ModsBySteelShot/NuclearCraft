...
public class IrradiatorRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(54, 23, 69, 41), "irradiating", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("irradiating")) && (getClass() == IrradiatorRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = IrradiatorRecipes.instance()
                .getRecipes();
    ...
    public void loadCraftingRecipes(ItemStack result) {
        Map<Object[], Object[]> recipes = IrradiatorRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            int pos = IrradiatorRecipes.instance()
