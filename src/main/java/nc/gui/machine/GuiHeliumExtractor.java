...
public class GuiHeliumExtractor extends GuiContainer {
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj.drawString(
            heliumExtractor.fluid + " mB",
            149 - this.fontRendererObj.getStringWidth(heliumExtractor.fluid + " mB"),
            this.ySize - 94,
            4210752);
    }
    ...
    public void drawGuiContainerBackgroundLayer(float f, int i, int j) {
        ...
        int k = (int) Math.ceil(
            this.heliumExtractor.cookTime * (23 + this.heliumExtractor.speedUpgrade / 3)
                / this.heliumExtractor.getProcessTime);
