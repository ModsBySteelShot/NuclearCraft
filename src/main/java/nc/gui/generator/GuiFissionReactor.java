...
public class GuiFissionReactor extends GuiContainer {
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        String egen = this.entity.fueltime == 0 ? 0 + " RF/t"
            : (this.entity.E < 100000 ? (this.entity.E) + " RF/t"
                : (this.entity.E < 10000000 ? ((int) (Math.round(this.entity.E / 1000))) + " kRF/t"
                    : ((int) (Math.round(this.entity.E / 1000000))) + " MRF/t"));
