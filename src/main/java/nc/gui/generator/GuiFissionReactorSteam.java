...
public class GuiFissionReactorSteam extends GuiContainer {
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        String name1 = (this.entity.lx - 2) + "x"
            + (this.entity.ly - 2)
            + "x"
            + (this.entity.lz - 2)
            + " "
        ...
        String power = this.entity.fluid + " mB"
            + (this.entity.S < 200 ? ""
                : (this.entity.S < 40000 ? " (" + StatCollector.translateToLocal("gui.dense") + ")"
        ...
        String fueltype = (this.entity.fueltime == 0 ? StatCollector.translateToLocal("gui.noFuel")
            : this.entity.typeoffuel) + "";
        this.fontRendererObj.drawString(fueltype, 67, 60, (this.entity.complete == 1 ? -1 : 15597568));

        String egen = this.entity.fueltime == 0 ? 0 + " mB/t"
            : (this.entity.S < 10000 ? (this.entity.S) + " mB/t"
                : (this.entity.S < 10000000 ? ((int) (Math.round(this.entity.S / 1000))) + " B/t"
                    : ((int) (Math.round(this.entity.S / 1000000))) + " kB/t"));
        this.fontRendererObj
            .drawString(egen, 7, 63, (this.entity.complete == 0 ? 15597568 : (this.entity.off == 1 ? 15641088 : -1)));
        int heatGen = this.entity.H >= 0 ? this.entity.H : -this.entity.MinusH;
        String hgen = Math.abs(heatGen) < 100000 ? (heatGen) + " H/t"
            : (Math.abs(heatGen) < 10000000 ? ((int) (Math.round(heatGen / 1000))) + " kH/t"
                : ((int) (Math.round(heatGen / 1000000))) + " MH/t");
        this.fontRendererObj
            .drawString(hgen, 7, 74, (this.entity.complete == 0 ? 15597568 : (this.entity.off == 1 ? 15641088 : -1)));

        String numberCells = /* StatCollector.translateToLocal("gui.cells") */ "Cells" + ": "
            + this.entity.numberOfCells;
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.drawTexturedModalRect(
            ...
            this.guiTop + 6 + 55 - k,
            176,
            3 + 55 - k + (this.entity.complete == 1 ? 0 : 55),
            16,
            k);
        ...
        this.drawTexturedModalRect(
            ...
            this.guiTop + 6 + 55 - k2,
            192,
            3 + 55 - k2 + (this.entity.complete == 1 ? 0 : 55),
            16,
            k2);
        ...
        this.drawTexturedModalRect(
            ...
            this.guiTop + 6 + 55 - k3,
            208,
            3 + 55 - k3 + (this.entity.complete == 1 ? 0 : 55),
            16,
            k3);
