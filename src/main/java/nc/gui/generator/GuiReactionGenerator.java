...
public class GuiReactionGenerator extends GuiContainer {
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj
            .drawString(name1, this.xSize / 2 - this.fontRendererObj.getStringWidth(name1) / 2, 5, 4210752);
        this.fontRendererObj
            .drawString(name2, this.xSize / 2 - this.fontRendererObj.getStringWidth(name2) / 2, 15, 4210752);
