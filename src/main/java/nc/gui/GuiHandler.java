        ...
        if (entity != null) {
            switch (ID) {
                ...
                case 8:
                    ...
                    return null;
                case 9:
                    if (entity instanceof TileNuclearWorkspace) return new ContainerNuclearWorkspace(
                        player.inventory,
                        world,
                        x,
                        y,
                        z,
                        (TileNuclearWorkspace) entity);
                    return null;
                case 10:
