    ...
    public static void addIC2Recipes() {
        ...
        try {
            Recipes.cannerEnrich.addRecipe(
                FluidRegistry.getFluidStack(FluidRegistry.WATER.getName(), 1000),
                new RecipeInputOreDict("universalReactant", 8),
                FluidRegistry.getFluidStack("ic2coolant", 1000));
        } catch (Exception e) {}
        try {
            Recipes.cannerEnrich.addRecipe(
                FluidRegistry.getFluidStack("distilledWater", 1000),
                new RecipeInputOreDict("universalReactant", 1),
                FluidRegistry.getFluidStack("ic2coolant", 1000));
        } catch (Exception e) {}
        ...
        // Compressor
        try {
            RecipesHelp.addCompressorRecipe(
                new ItemStack(NCItems.parts, 1, 0),
                NuclearCraft.workspace ? 4 : 8,
        ...
        // Thermal Centrifuge
        try {
            RecipesHelp.addCentrifugeRecipe(
                new RecipeInputOreDict("ingotLithium", 1),
                250,
                new ItemStack(NCItems.material, 1, 47),
                new ItemStack(NCItems.material, 1, 69));
        } catch (Exception e) {}
        try {
            RecipesHelp.addCentrifugeRecipe(
                new RecipeInputOreDict("ingotBoron", 1),
                250,
                new ItemStack(NCItems.material, 1, 49),
                new ItemStack(NCItems.material, 3, 70));
        } catch (Exception e) {}
        try {
            RecipesHelp.addCentrifugeRecipe(
                new RecipeInputOreDict("dustLithium", 1),
                250,
                new ItemStack(NCItems.material, 1, 47),
                new ItemStack(NCItems.material, 1, 69));
        } catch (Exception e) {}
        try {
            RecipesHelp.addCentrifugeRecipe(
                new RecipeInputOreDict("dustBoron", 1),
                250,
                new ItemStack(NCItems.material, 1, 49),
                new ItemStack(NCItems.material, 3, 70));
        } catch (Exception e) {}
        ...
        try {
            RecipesHelp.addCentrifugeRecipe(
                new ItemStack(NCItems.fuel, 1, 41),
                1,
                1000,
                new ItemStack(NCItems.material, 1, 46));
        } catch (Exception e) {}
        try {
            RecipesHelp.addCentrifugeRecipe(
                new ItemStack(NCItems.fuel, 1, 42),
                1,
                1000,
                new ItemStack(NCItems.material, 1, 47));
        } catch (Exception e) {}
        try {
            RecipesHelp.addCentrifugeRecipe(
                new ItemStack(NCItems.fuel, 1, 43),
                1,
                1000,
                new ItemStack(NCItems.material, 1, 48));
        } catch (Exception e) {}
        try {
            RecipesHelp.addCentrifugeRecipe(
                new ItemStack(NCItems.fuel, 1, 44),
                1,
                1000,
                new ItemStack(NCItems.material, 1, 49));
        } catch (Exception e) {}
