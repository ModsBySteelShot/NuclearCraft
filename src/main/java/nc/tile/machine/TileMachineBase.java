...
public abstract class TileMachineBase extends TileInventory implements IEnergyHandler, IEnergyReceiver {
    ...
    public TileMachineBase(String localName, int energyMax, int inSize, int outSize, boolean usesUpgrades,
        boolean usesEnergy, double pt, double er, int smod, int tmod, NCRecipeHelper ncrecipes) {
