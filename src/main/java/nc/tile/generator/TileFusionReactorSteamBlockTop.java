...
public class TileFusionReactorSteamBlockTop extends TileEntity implements IFluidHandler, IEnergyHandler,
    IEnergyConnection, IEnergyReceiver, IEnergyProvider, ISidedInventory, IGasHandler, ITubeConnection {
    ...
    public void updateEntity() {
        ...
        if (this.worldObj.getBlock(xCoord, yCoord, zCoord) == NCBlocks.fusionReactorSteamBlockTop
    ...
    public void getOffsets(int x, int y, int z) {
        if (worldObj.getBlock(x, y - 2, z) == NCBlocks.fusionReactorSteam) {
            xOffset = 0;
            yOffset = -2;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y - 2, z) == NCBlocks.fusionReactorSteam) {
            xOffset = 1;
            yOffset = -2;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y - 2, z + 1) == NCBlocks.fusionReactorSteam) {
            xOffset = 1;
            yOffset = -2;
            zOffset = 1;
        } else if (worldObj.getBlock(x, y - 2, z + 1) == NCBlocks.fusionReactorSteam) {
            xOffset = 0;
            yOffset = -2;
            zOffset = 1;
        } else if (worldObj.getBlock(x - 1, y - 2, z + 1) == NCBlocks.fusionReactorSteam) {
