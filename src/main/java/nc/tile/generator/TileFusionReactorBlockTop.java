...
public class TileFusionReactorBlockTop extends TileEntity implements IEnergyHandler, IEnergyConnection, IEnergyReceiver,
    ...
    public void updateEntity() {
        ...
        if (this.worldObj.getBlock(xCoord, yCoord, zCoord) == NCBlocks.fusionReactorBlockTop
    ...
    public void getOffsets(int x, int y, int z) {
        if (worldObj.getBlock(x, y - 2, z) == NCBlocks.fusionReactor) {
            xOffset = 0;
            yOffset = -2;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y - 2, z) == NCBlocks.fusionReactor) {
            xOffset = 1;
            yOffset = -2;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y - 2, z + 1) == NCBlocks.fusionReactor) {
            xOffset = 1;
            yOffset = -2;
            zOffset = 1;
        } else if (worldObj.getBlock(x, y - 2, z + 1) == NCBlocks.fusionReactor) {
            xOffset = 0;
            yOffset = -2;
            zOffset = 1;
        } else if (worldObj.getBlock(x - 1, y - 2, z + 1) == NCBlocks.fusionReactor) {
