...
public class TileFusionReactorBlock extends TileEntity implements IEnergyHandler, IEnergyConnection, IEnergyReceiver,
    IEnergyProvider, ISidedInventory, IGasHandler, ITubeConnection {
    ...
    public void updateEntity() {
        ...
        if (this.worldObj.getBlock(xCoord, yCoord, zCoord) == NCBlocks.fusionReactorBlock
    ...
    public void getOffsets(int x, int y, int z) {
        if (worldObj.getBlock(x, y - 1, z) == NCBlocks.fusionReactor) {
            xOffset = 0;
            yOffset = -1;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y, z) == NCBlocks.fusionReactor) {
            xOffset = 1;
            yOffset = 0;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y, z + 1) == NCBlocks.fusionReactor) {
            xOffset = 1;
            yOffset = 0;
            zOffset = 1;
        } else if (worldObj.getBlock(x, y, z + 1) == NCBlocks.fusionReactor) {
            xOffset = 0;
            yOffset = 0;
            zOffset = 1;
        } else if (worldObj.getBlock(x - 1, y, z + 1) == NCBlocks.fusionReactor) {
        ...
        else if (worldObj.getBlock(x + 1, y - 1, z) == NCBlocks.fusionReactor) {
            xOffset = 1;
            yOffset = -1;
            zOffset = 0;
        } else if (worldObj.getBlock(x + 1, y - 1, z + 1) == NCBlocks.fusionReactor) {
            xOffset = 1;
            yOffset = -1;
            zOffset = 1;
        } else if (worldObj.getBlock(x, y - 1, z + 1) == NCBlocks.fusionReactor) {
            xOffset = 0;
            yOffset = -1;
            zOffset = 1;
        } else if (worldObj.getBlock(x - 1, y - 1, z + 1) == NCBlocks.fusionReactor) {
