...
public class ItemFuel extends ItemMeta {
    ...
    public String[] fuelInfo(int power, int time, int heat) {
        String[] inf = { "Base Power: " + power * NuclearCraft.fissionRF / 100 + " RF/t",
            "Base Lifetime: " + (10000000 / (time * 20)) * NuclearCraft.fissionEfficiency + " s",
            "Base Heat: " + heat + " H/t", "For a Fission Reactor with c Cell Compartments and an Efficiency of e,",
            ...
            "Each Cell Compartment adjacent to n other Cell Compartments, or Graphite", "blocks followed",
            "by Cell Compartments in the same direction produces", "(n+1)(n+2)/2 times the Base Heat of the fuel.", "",
            "In addition, the higher the heat level of the reactor, the more efficient", "the fuel will be." };
        return inf;
    }
