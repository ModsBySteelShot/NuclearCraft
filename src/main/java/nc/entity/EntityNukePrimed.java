        ...
        if (this.fuse-- <= 0) {
            ...
            if (!this.worldObj.isRemote) {
                this.explode(
                    ...
                    this.posY,
                    this.posZ,
                    0.6F * NuclearCraft.explosionRadius,
                    BombType.BOMB_STANDARD);
            }
        } else {
            this.worldObj.spawnParticle("lava", this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX - 0.375D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX - 0.125D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX + 0.125D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX + 0.375D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX - 0.375D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX - 0.125D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX + 0.125D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.0D, 0.0D);
            this.worldObj
                .spawnParticle("smoke", this.posX + 0.375D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.0D, 0.0D);
