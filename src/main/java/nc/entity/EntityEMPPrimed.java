...
public class EntityEMPPrimed extends Entity {
    ...
    public void onUpdate() {
        ...
        if (this.fuse-- <= 0) {
            ...
            this.worldObj
                .spawnParticle("reddust", this.posX - 0.375D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX - 0.125D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX + 0.125D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX + 0.375D, this.posY + 0.5D, this.posZ - 0.375D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX - 0.375D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX - 0.125D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX + 0.125D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.1D, 0.0D);
            this.worldObj
                .spawnParticle("reddust", this.posX + 0.375D, this.posY + 0.5D, this.posZ - 0.125D, 0.0D, 0.1D, 0.0D);
    ...
    private void explode(World world) {
        ...
        for (int i = -((int) (0.5D * NuclearCraft.explosionRadius)); i
            <= ((int) (0.5D * NuclearCraft.explosionRadius)); i++) {
            for (int j = -((int) (0.5D * NuclearCraft.explosionRadius)); j
                <= ((int) (0.5D * NuclearCraft.explosionRadius)); j++) {
                for (int k = -((int) (0.5D * NuclearCraft.explosionRadius)); k
                    <= ((int) (0.5D * NuclearCraft.explosionRadius)); k++) {
                    if (i * i + j * j + k * k
                        <= ((int) (0.5D * NuclearCraft.explosionRadius)) * ((int) (0.5D * NuclearCraft.explosionRadius))
                        && world.getTileEntity(x + i, y + j, z + k) != null) {
