...
public class EntityBullet extends EntityArrow implements IProjectile {
    ...
    public EntityBullet(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_) {
        ...
        this.setLocationAndAngles(
            p_i1756_2_.posX,
            p_i1756_2_.posY + (double) p_i1756_2_.getEyeHeight(),
            p_i1756_2_.posZ,
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_,
        ...
        p_70186_1_ += this.rand.nextGaussian() * (double) (this.rand.nextBoolean() ? -1 : 1)
            * 0.0005D
            * (double) p_70186_8_;
        p_70186_3_ += this.rand.nextGaussian() * (double) (this.rand.nextBoolean() ? -1 : 1)
            * 0.0005D
            * (double) p_70186_8_;
        p_70186_5_ += this.rand.nextGaussian() * (double) (this.rand.nextBoolean() ? -1 : 1)
            * 0.0005D
            * (double) p_70186_8_;
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_) {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if (this.canBePickedUp == 1
                && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(NCItems.dUBullet, 1))) {
                flag = false;
            }
