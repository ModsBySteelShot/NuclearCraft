        ...
        if (!player.isSneaking()) {
            if ((player != null) && (!world.isRemote)) {
                if (world.getBlock(x, y - 2, z) == NCBlocks.fusionReactor)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 11, world, x, y - 2, z);
                else if (world.getBlock(x + 1, y - 2, z) == NCBlocks.fusionReactor)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 11, world, x + 1, y - 2, z);
                else if (world.getBlock(x + 1, y - 2, z + 1) == NCBlocks.fusionReactor)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 11, world, x + 1, y - 2, z + 1);
                else if (world.getBlock(x, y - 2, z + 1) == NCBlocks.fusionReactor)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 11, world, x, y - 2, z + 1);
                else if (world.getBlock(x - 1, y - 2, z + 1) == NCBlocks.fusionReactor)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 11, world, x - 1, y - 2, z + 1);
                else if (world.getBlock(x - 1, y - 2, z) == NCBlocks.fusionReactor)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 11, world, x - 1, y - 2, z);
