...
public class BlockReactionGenerator extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.blockIcon = iconRegister
            .registerIcon("nc:generator/reactionGenerator/" + (this.isActive ? "active" : "idle"));
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler
                .openGui(player, NuclearCraft.instance, NuclearCraft.guiIdReactionGenerator, world, x, y, z);
        }
        return true;
    }
