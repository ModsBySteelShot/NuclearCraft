...
public class BlockElectromagnet extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.blockIcon = iconRegister
            .registerIcon("nc:generator/fusionEM/" + "side" + (this.isActive ? "Active" : "Idle"));
        this.iconTop = iconRegister
            .registerIcon("nc:generator/fusionEM/" + "top" + (this.isActive ? "Active" : "Idle"));
        this.iconBottom = iconRegister
            .registerIcon("nc:generator/fusionEM/" + "bottom" + (this.isActive ? "Active" : "Idle"));
    }
