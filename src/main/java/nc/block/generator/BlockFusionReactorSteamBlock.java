        ...
        if (!player.isSneaking()) {
            if ((player != null) && (!world.isRemote)) {
                if (world.getBlock(x, y - 1, z) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x, y - 1, z);
                else if (world.getBlock(x + 1, y, z) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x + 1, y, z);
                else if (world.getBlock(x + 1, y, z + 1) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x + 1, y, z + 1);
                else if (world.getBlock(x, y, z + 1) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x, y, z + 1);
                else if (world.getBlock(x - 1, y, z + 1) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x - 1, y, z + 1);
                else if (world.getBlock(x - 1, y, z) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x - 1, y, z);
                    ...
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x + 1, y - 1, z);
                else if (world.getBlock(x + 1, y - 1, z + 1) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x + 1, y - 1, z + 1);
                else if (world.getBlock(x, y - 1, z + 1) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x, y - 1, z + 1);
                else if (world.getBlock(x - 1, y - 1, z + 1) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x - 1, y - 1, z + 1);
                else if (world.getBlock(x - 1, y - 1, z) == NCBlocks.fusionReactorSteam)
                    FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x - 1, y - 1, z);
