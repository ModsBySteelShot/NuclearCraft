...
public class BlockFusionReactor extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int q, float a, float b,
        float c) {
    ...
    public boolean canPlaceBlockAt(World world, int x, int y, int z) {
        if (world.getBlock(x + 1, y, z)
        ...
        else if (world.getBlock(x + 1, y, z + 1)
            .getMaterial() != Material.air) return false;
            ...
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x + 1, y + 1, z)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x + 1, y + 1, z + 1)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x, y + 1, z + 1)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x - 1, y + 1, z + 1)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x - 1, y + 1, z)
        ...
        else if (world.getBlock(x, y + 2, z)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x + 1, y + 2, z)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x + 1, y + 2, z + 1)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x, y + 2, z + 1)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x - 1, y + 2, z + 1)
            .getMaterial() != Material.air) return false;
        else if (world.getBlock(x - 1, y + 2, z)
    ...
    public int getComparatorInputOverride(World world, int x, int y, int z, int i) {
        TileFusionReactor tileentity = (TileFusionReactor) world.getTileEntity(x, y, z);
        return tileentity.efficiency <= NuclearCraft.fusionComparatorEfficiency
            ? (int) (15D * tileentity.efficiency / NuclearCraft.fusionComparatorEfficiency)
            : 15;
    }
