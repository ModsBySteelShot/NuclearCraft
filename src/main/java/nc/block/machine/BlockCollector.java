...
public class BlockCollector extends BlockMachine {
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random) {
        if (isActive) {
            ...
            world
                .spawnParticle("depthsuspend", (double) (x1 + f1), (double) (y2), (double) (z1 + f2), 0.0D, 0.0D, 0.0D);
            world.spawnParticle("depthsuspend", (double) (x1 - f), (double) (y1), (double) (z1 + f1), 0.0D, 0.0D, 0.0D);
            world
                .spawnParticle("depthsuspend", (double) (x1 + f0), (double) (y1), (double) (z1 + f1), 0.0D, 0.0D, 0.0D);
            world.spawnParticle("depthsuspend", (double) (x1 + f1), (double) (y1), (double) (z1 - f), 0.0D, 0.0D, 0.0D);
            world
                .spawnParticle("depthsuspend", (double) (x1 + f1), (double) (y1), (double) (z1 + f0), 0.0D, 0.0D, 0.0D);
        }
    }
}
