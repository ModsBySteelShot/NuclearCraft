...
public class BlockNuclearFurnace extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        this.iconFront = iconRegister
            .registerIcon("nc:machine/nuclearFurnace/" + "front" + (this.isActive ? "Active" : "Idle"));
    ...
    public static void updateNuclearFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord,
        int zCoord) {
