...
public class BlockPlasma extends BlockFluidClassic {
    ...
    public boolean f(World world, int x, int y, int z) {
        return world.getBlock(x, y, z) != NCBlocks.electromagnetActive
            && world.getBlock(x, y, z) != NCBlocks.fusionReactor
            && world.getBlock(x, y, z) != NCBlocks.fusionReactorBlock
    ...
    public boolean g(World world, int x, int y, int z) {
        return world.getBlock(x, y, z) != NCBlocks.electromagnetIdle
            && world.getBlock(x, y, z) != NCBlocks.electromagnetActive
            && world.getBlock(x, y, z) != NCBlocks.blockFusionPlasma;
    }

    public void updateTick(World world, int x, int y, int z, Random rand) {
        /*
         * if (rand1.nextFloat() > 0.0F && g(world, x, y - 1, z) && !this.isSourceBlock(world, x, y, z))
         * world.setBlock(x, y, z, NCBlocks.plasmaFire);
         * if (tickCount >= 20) {
         * if (this.isSourceBlock(world, x, y, z) && (world.getBlock(x, y + 1, z) == Blocks.air || world.getBlock(x, y +
         * 1, z) == NCBlocks.plasmaFire || world.getBlock(x, y + 1, z) == NCBlocks.blockFusionPlasma)) {
