        ...
        if (world.getBlock(x, y, z) == this) {
            if (this.blockMaterial == NuclearCraft.liquidhelium) {
                ...
                if (world.getBlock(x, y, z - 1)
                    ...
                    if (l == 0) world.setBlock(x, y, z - 1, Blocks.obsidian);
                    else if (l <= 4) world.setBlock(x, y, z - 1, Blocks.stone);
                }
                if (world.getBlock(x, y, z + 1)
                    .getMaterial() == Material.lava) {
                    l = world.getBlockMetadata(x, y, z + 1);
                ...
                if (world.getBlock(x - 1, y, z)
                    ...
                    if (l == 0) world.setBlock(x - 1, y, z, Blocks.obsidian);
                    else if (l <= 4) world.setBlock(x - 1, y, z, Blocks.stone);
                }
                if (world.getBlock(x + 1, y, z)
                    .getMaterial() == Material.lava) {
                    l = world.getBlockMetadata(x + 1, y, z);
                ...
                if (world.getBlock(x, y + 1, z)
                    ...
                    if (l == 0) world.setBlock(x, y + 1, z, Blocks.obsidian);
                    else if (l <= 4) world.setBlock(x, y + 1, z, Blocks.stone);
                }
                if (world.getBlock(x, y - 1, z)
                    .getMaterial() == Material.lava) {
                    l = world.getBlockMetadata(x, y - 1, z);
