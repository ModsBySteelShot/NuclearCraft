...
public class BlockSynchrotron extends BlockMachine {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.blockIcon = iconRegister
            .registerIcon("nc:accelerator/synchrotron/" + "side" + (this.isActive ? "Active" : "Idle"));
        this.iconFront = iconRegister
            .registerIcon("nc:accelerator/synchrotron/" + "front" + (this.isActive ? "Active" : "Idle"));
        this.iconTop = iconRegister
            .registerIcon("nc:accelerator/synchrotron/" + "top" + (this.isActive ? "Active" : "Idle"));
        this.iconBottom = iconRegister
            .registerIcon("nc:accelerator/synchrotron/" + "bottom" + (this.isActive ? "Active" : "Idle"));
    }
