...
public class BlockSuperElectromagnet extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.blockIcon = iconRegister
            .registerIcon("nc:accelerator/electromagnet/" + "side" + (this.isActive ? "Active" : "Idle"));
        this.iconTop = iconRegister
            .registerIcon("nc:accelerator/electromagnet/" + "top" + (this.isActive ? "Active" : "Idle"));
        this.iconBottom = iconRegister
            .registerIcon("nc:accelerator/electromagnet/" + "bottom" + (this.isActive ? "Active" : "Idle"));
    }
